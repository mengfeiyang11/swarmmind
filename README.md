...
SwarmMind 是一个基于 LangChain 构建的多智能体协作框架，专为技术研究和自动化任务设计。系统采用 **Planner → Executor → Reviewer** 三阶段协作模式，具备完善的沙箱隔离、权限控制和审计日志能力。
